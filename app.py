...
def match():
    ...
    return render_template("match.html", current_page='match', users=users_list, notifications=notifications, requests=requests, verified=current_user.verified, profile_pic_url=profile_pic_url, actor_details=actor_details)
